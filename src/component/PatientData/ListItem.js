    ...
    render() {
      ...
      return (
        <View>
          ...
          <Text>{this.props.disease.name}</Text>
          <TouchableHighlight onPress={this.props.onTaskCompletion}>
            <Image source={{uri: 'https://1.bp.blogspot.com/-uRaHoFqqsxY/V70he-ZYRlI/AAAAAAAAA7A/S4Js-D6sMR8vs28NFv7W39rFRAPX7XIWgCLcB/s1600/ic_done_black_24dp.png'}} />
          </TouchableHighlight>
